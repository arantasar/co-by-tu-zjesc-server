...
namespace API.Controllers
{
    ...
    public class IngredientsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Ingredient>> Add([FromForm]IngredientForCreationDto ingredientForCreationDto)
        {
            ...
            {
                uniqueFileName = PhotoHelper.AddPhoto(ingredientForCreationDto.Photo, HttpContext, "Photos", "IngredientPhotos");
            }
            ...
            var ingredient = new Ingredient
            {
                ...
                Alternatives = JsonSerializer.Deserialize<List<Ingredient>>(ingredientForCreationDto.Alternatives, serializeOptions),
                Units = JsonSerializer.Deserialize<List<Unit>>(ingredientForCreationDto.Units, serializeOptions),
